 ...
 */
public class ExceptionDetailsDialog extends IconAndMessageDialog
{
	/**
	 ...
	 */
	public ExceptionDetailsDialog(Shell parentShell, String dialogTitle, String message, IStatus status, int displayMask)
	{
		super(parentShell);
	...
	{
		ExceptionDetailsDialog dialog = new ExceptionDetailsDialog(parentShell, title, message, status, displayMask);
		return dialog.open();
	}
